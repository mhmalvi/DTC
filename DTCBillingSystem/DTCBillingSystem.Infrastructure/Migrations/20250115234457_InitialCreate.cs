        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousReading = table.Column<decimal>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PresentReading = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    PreviousReading = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    ACPresentReading = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: true),
                    ACPreviousReading = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: true),
                    BlowerFanCharge = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    GeneratorCharge = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    ServiceCharge = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<string>(type: "TEXT", nullable: false),
                    LastModifiedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "TEXT", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LatePaymentCharges = table.Column<decimal>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2025, 1, 15, 23, 44, 57, 400, DateTimeKind.Utc).AddTicks(8903), "system", "admin@dtcbilling.com", "System", true, null, new DateTime(2025, 1, 15, 23, 44, 57, 400, DateTimeKind.Utc).AddTicks(8904), "system", "Administrator", new byte[] { 200, 223, 60, 174, 70, 235, 226, 86, 154, 222, 198, 14, 182, 16, 207, 215, 220, 173, 147, 81, 223, 44, 191, 4, 186, 202, 182, 164, 105, 227, 226, 139 }, new byte[] { 142, 253, 67, 38, 227, 103, 81, 247, 123, 23, 110, 176, 119, 85, 59, 118, 65, 135, 73, 16, 183, 203, 247, 59, 203, 217, 36, 68, 194, 143, 178, 210 }, null, false, 0, null, "admin" });
